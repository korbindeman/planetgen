 ...
 * stream-power recipe here. See docs/carve-hydrology.md.
 */
'use strict';

function run() {
    throw new Error(
        '@planetgen/hydrology is a named slot. Fine drainage runs on the baked DEM, not the planetgen mesh. See docs/carve-hydrology.md.',
    );
}
