...
How hard to cut is **open**. The 90 m bake already looks eroded; this pass has to connect drainage without a second landscape-evolution. See `docs/carve-hydrology.md`.
